...
&gt; Desarrolladora con **experiencia profesional en implementación de Odoo ERP**, creación de **módulos personalizados**, desarrollo **Android (Java + Android Studio)**, aplicaciones web con **Django**, y sitios corporativos (WordPress). 

&gt; Formación técnica en **DAM (Desarrollo de Aplicaciones Multiplataforma)** en el IES Sabadell + **42 Barcelona**. Combino perfil **técnico y comercial**: entiendo las necesidades del negocio y las traduzco a soluciones digitales escalables.

&gt; 🎓 **Próximamente**: Ingeniería Electrónica y Automática
...
- 🔭 **Buscando nuevas oportunidades** como desarrolladora (Odoo, Android, Full Stack, Backend Python/Java)
- 🎓 **Próximamente**: Ingeniería Electrónica y Automática
- 🌱 **Abierta a colaborar** en proyectos open source, especialmente Odoo y Android
- 💬 **Pregúntame sobre**: Implementación Odoo, apps Android, Django, optimización WordPress
